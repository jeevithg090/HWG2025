...
export class EventService {
  ...
  public async updateEvent(id: string, eventData: Partial<CreateEventInput>): Promise<Event | null> {
  ...
  public async registerForEvent(
    ...
    const existingRegistration = await eventAttendeeRepository.findByUserIdAndEventId(
      attendeeData.userId, 
      eventId
    );
  ...
  public async cancelRegistration(
    ...
    const registration = await eventAttendeeRepository.findByUserIdAndEventId(userId, eventId);
