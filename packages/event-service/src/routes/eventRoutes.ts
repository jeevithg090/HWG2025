...
eventRouter.get("/", (async (req, res) => {
  try {
    const { isActive, eventType, isPublished, page, limit } = req.query;
...
// Mark attendance
eventRouter.post("/attendees/:attendeeId/mark-attendance", (async (
  req,
  res
) => {
  try {
