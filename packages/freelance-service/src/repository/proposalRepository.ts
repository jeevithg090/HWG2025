...
export class ProposalRepository {
  ...
  async findAll(filter?: Partial<Proposal>, skip = 0, take = 10): Promise<Proposal[]> {
  ...
  async updateProposal(id: string, proposalData: Partial<Proposal>): Promise<Proposal | null> {
